...
- Export your full cost history to CSV at tax time — your accountant will love you

---

## Working with Vendors

### 8. Build Your Vendor Network
...
- You can see the full scoring breakdown — exactly why each vendor was recommended

### 10. Vendor Responds via Magic Link
...
- The vendor clicks the link and can:
  - **Accept** the job
  - **Decline** the job
...
### 11. Use the Scheduling Calendar
...
### 12. Dispatch Board (Kanban View)

- Go to **Dispatch Board** for a visual pipeline of all your work orders
- See your requests organized into columns:
  - **Needs Dispatch** → **Awaiting Response** → **Scheduled** → **In Progress** → **Completed**
...
### 13. Rate Vendors After Each Job

- When a job is completed, leave a review rating:
  - **Quality** of work
  - **Speed** of completion
  - **Communication** throughout the job
  - **Price** fairness
- TenantTrack automatically calculates a **Trust Score from 0 to 100** for each vendor based on their full performance history
- Higher-scoring vendors get prioritized in auto-dispatch — so your best vendors naturally get more work
- Vendors who no-show or get poor reviews see their score drop — protecting you from repeat bad experiences

---

## Recurring Maintenance

### 14. Set Up Preventive Tasks
...
### 15. Choose a Plan When You're Ready

| Plan | Monthly Price | Best For | Properties | Key Features |
|------|:---:|---|:---:|---|
| **Starter** | $29/mo | 1–5 units | Up to 5 | QR system, vendor dispatch, email alerts, photo uploads |
...
- **Activity Log** — Every request has a full timestamped log of every action taken, giving you a paper trail for disputes or insurance claims
- **SLA monitoring** — The system automatically watches response deadlines and alerts you if a vendor hasn't responded in time, then suggests the next best vendor
- **No vendor accounts needed** — Vendors never need to download an app or create an account. Everything works through magic links in their email
- **Overdue alerts** — Requests open for more than 7 days without resolution are flagged as overdue on your dashboard
- **Staff accounts** — On Growth and Pro plans, add staff members who can manage requests and dispatch vendors on your behalf
...
*TenantTrack — Stop chasing vendors. Start managing maintenance.*
