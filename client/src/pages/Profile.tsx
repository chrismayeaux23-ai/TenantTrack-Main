...
import { Loader2, Save, User, Mail, Phone, Building2, Crown } from "lucide-react";
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h2 className="text-xl font-bold" data-testid="text-profile-name">
                {profile?.firstName || profile?.email || "Landlord"}
              </h2>
              <div className="flex items-center gap-2 mt-1">
                <Crown className="h-4 w-4 text-primary" />
                <Badge variant={tierInfo.variant} data-testid="text-subscription-tier">{tierInfo.label}</Badge>
              </div>
            </div>
          </div>
